...
class EmailRateLimit(Base):
    ...
    erl_first_attempt_at = Column(DateTime, nullable=False)
    erl_last_attempt_at = Column(DateTime, nullable=False)
    erl_blocked_until = Column(DateTime, nullable=False)
    erl_created_at = Column(DateTime, nullable=False)
